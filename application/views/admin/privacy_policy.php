                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                         ...
                         <form method="POST" action="<?php echo base_url('add_privacy_policy');?>"  class="form-horizontal" enctype="multipart/form-data" autocomplete="off">
							<input type="hidden" name="id" value="<?php echo $privacy_policy[0]['id'];?>">
                                ...
                                <div class="form-group">
                                  <div class="col-md-12"><label class="control-label">Description</label></div>
                                   ...
                                   <div class="col-md-5">
                                   <textarea class="form-control" rows="10" name="description" id="comment"><?php echo $privacy_policy[0]['description'];?></textarea>
                                </div>
                                 <div class="col-md-5">
