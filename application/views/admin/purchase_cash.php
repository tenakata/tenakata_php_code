...
.ml-2{
 ...
 <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Purchase Cash List</h2>
                    <ol class="breadcrumb">
                       
                        
                        <li class="active">
                            <strong>Purchase Cash  list</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <a href="<?php echo base_url();?>index.php/purchase_cash"  class="btn btn-primary anchor active"> Purchase Cash List</a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="<?php echo base_url();?>index.php/purchase_credit"  class="btn btn-primary anchor ml-2" > Purchase Credit List</a>
                </div>
                    <a href="<?= base_url('index.php/purchase_cash_export');?>"><button class="float-right btn btn-md btn-success" style="float: right;">Export </button></a>
                    </div>
