...
class Migration_Create_credit_sales_purchases_table extends CI_Migration {
        ...
        public function up()
        {
                ...
                $this->dbforge->create_table('credit_sales_purchases');
        }

        public function down()
        {
                $this->dbforge->drop_table('credit_sales_purchases');
        }
}
?>